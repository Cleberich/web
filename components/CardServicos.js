...
const CardServicos = ({ service }) => {
  const [mostrar, setMostrar] = useState(false);
  const { info, nombre } = service;
  return (
    <>
        ...
        <div className="relative w-full mx-auto mt-[10%] h-full max-w-2xl md:h-auto">
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
              <a
                href={`https://api.whatsapp.com/send?phone=59892997991&text=Hola%20me%20interesa%20el%20servicio%20de%20${nombre}`}
