    ...
    <>
      <div className="max-w-sm p-6 bg-[#121212] shadow-xl rounded-lg w-[350px] h-[250px] md:card">
        ...
        <p className="mb-3 font-normal text-gray-100 formatearTexto">
          Trabajamos juntos en el crecimiento de tu ecommerce, somos expertos en
          entender las oportunidades que puede brindar cada plataforma para
          potenciar al máximo cada aspecto de tu tienda. Trabajamos con todas
          las plataformas digitales para atraer tráfico calificado y
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-6 space-y-6">
              <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                Trabajamos juntos en el crecimiento de tu ecommerce, somos
                expertos en entender las oportunidades que puede brindar cada
                plataforma para potenciar al máximo cada aspecto de tu tienda.
                Trabajamos con todas las plataformas digitales para atraer
                tráfico calificado y convertirlos en clientes.
              </p>
            </div>
