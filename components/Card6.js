    ...
    <>
      <div className="max-w-sm p-6 bg-[#121212] shadow-xl rounded-lg w-[350px] h-[250px] md:card">
        ...
        <p className="mb-3 font-normal text-gray-100 formatearTexto">
          Desarrollamos producciones audiovisuales con nuestro equipo interno en
          donde buscamos crear un concepto creativo y transmitirlo en cada toma
          tanto terrestre como aérea. ¿Estás listo para crear tu video
          institucional?
        </p>
        <button
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-6 space-y-6">
              <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                Desarrollamos producciones audiovisuales con nuestro equipo
                interno en donde buscamos crear un concepto creativo y
                transmitirlo en cada toma tanto terrestre como aérea. ¿Estás
                listo para crear tu video institucional?
              </p>
            </div>
