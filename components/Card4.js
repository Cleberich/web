    ...
    <>
      <div className="max-w-sm p-6 bg-[#121212] shadow-xl rounded-lg w-[350px] h-[250px] md:card">
        ...
        <p className="mb-3 font-normal text-gray-100 formatearTexto">
          Creamos ecommerce y web a medida de las necesidades de tu empresa, te
          acompañamos en todos el proceso de implementación y capacitamos a tu
          equipo para que puedan gestionar esta herramienta.
        </p>
        <button
          ...
          <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div className="p-6 space-y-6">
              <p className="text-base leading-relaxed text-gray-500 dark:text-gray-400">
                Creamos ecommerce y web a medida de las necesidades de tu
                empresa, te acompañamos en todos el proceso de implementación y
                capacitamos a tu equipo para que puedan gestionar esta
                herramienta.
              </p>
            </div>
