    ...
    <Layout2>
      <main className="fondoAnimado">
        <h2 className="text-3xl text-white mx-5 md:mx-24 font-light py-12 animate__animated animate__jackInTheBox">
          Un mercado cada vez más competitivo y desafiante nos impulsa a buscar
          nuevas formas de comunicarnos y llegar a nuestros clientes.
        </h2>
        ...
        <h2 className="text-3xl text-white  mx-5 md:mx-24 font-light mt-12 animate__animated animate__jackInTheBox">
          ...
          trabajo logrando de esta forma un diferencial a la hora de plantearnos
          objetivos ya que buscamos ser parte de tu empresa y ayudarte en todos
          los procesos necesarios para crecer.
        </h2>
